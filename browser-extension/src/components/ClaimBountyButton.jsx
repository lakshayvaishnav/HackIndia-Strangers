...
const ClaimBountyButton = ({ bounties }) => {
  ...
  const handleMouseOver = (option) => {
    const dropdownItem = document.querySelector(
      `#solbounty-dropdown-item-${option}`
    );
  ...
  return (
    <div style={{ position: "relative", display: "inline-block" }}>
      <div
        id="solbounty-claim-button"
        style={{
          display: "flex",
          alignItems: "center",
          border: isDarkMode ? "solid 1px #30363D" : "solid 1px #D0D7DE",
          borderRadius: "6px",
      ...
      >
        ...
        >
          <SolanaLogo
            height="11"
            color={
              isDarkMode ? "#ffffff" : selectedOption ? "#ffffff" : "#24292F"
            }
          />
          Attempt for Issue{" "}
          {selectedOption ? `#${selectedOption.issue_number}` : ""}
        </button>
        <button
        ...
        >
          {issues.map((issue, index) => (
            ...
            >
              ...
              >
                #{issue.issue_number} • {issue.amount} {issue.token}
              </p>
              <p
                style={{
                  margin: "0",
                  color: isDarkMode ? "#8D96A0" : "#636C76",
                  fontSize: "11px",
