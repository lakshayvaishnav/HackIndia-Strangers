...
export default function BountyButton({ title, userDetails, prUrl }) {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <section
          className="sol-bounty-modal-overlay"
          style={{
            position: "fixed",
            top: "0",
            left: "0",
        ...
        >
          <div
            className="sol-bounty-modal-content"
            style={{
            ...
            >
              ...
              {transactionError && (
                ...
                >
                  ...
                  <p
                    style={{ fontSize: "12px", margin: "0", textWrap: "wrap" }}
                  >
                    {transactionError}
                  </p>
                </div>
            ...
            >
              ...
              {!(signature && !transactionError) &&
                (tokenAmount > 0 && user?.account_addr ? (
                  <button
                    onClick={() =>
                      sendBounty(tokenAmount, tokenType, user?.account_addr)
                    }
                    style={{
                      padding: "5px 16px",
                      backgroundColor: "#238636",
