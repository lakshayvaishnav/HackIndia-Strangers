            ...
            {transactions.map((transaction: any, index: number) => (
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <a
                      ...
                      className="text-base font-medium text-zinc-800 leading-none hover:underline cursor-pointer"
                    >
                      {transaction.to.name
                        ? transaction.to.name
                    ...
                    <a
                      ...
                      className="text-sm text-zinc-500 leading-none hover:underline cursor-pointer"
                    >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-zinc-700 font-medium text-base flex items-center gap-1">
                    {transaction.amount}
