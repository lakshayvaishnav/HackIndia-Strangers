  ...
  const menu: Menu[] = [
    {
      label: "Home",
      href: "/dashboard/home",
      icon: <HomeOutlinedIcon color="#71717a" />,
      iconActive: <HomeOutlinedIcon color="#3f3f46" />,
    },
    {
      label: "Create bounty",
      href: "/dashboard/create-bounty",
      icon: <PlusOutlinedIcon color="#71717a" />,
      iconActive: <PlusOutlinedIcon color="#3f3f46" />,
    },
    {
      label: "Explore bounty",
      href: "/dashboard/explore-bounty",
      icon: <SearchOutlinedIcon color="#71717a" />,
      iconActive: <SearchOutlinedIcon color="#3f3f46" />,
    },
    {
      label: "Leaderboard",
      href: "/dashboard/leaderboard",
      icon: <MedalOutlinedIcon color="#71717a" />,
      iconActive: <MedalOutlinedIcon color="#3f3f46" />,
    },
    {
      label: "Transactions",
      href: "/dashboard/transactions",
      icon: <CurrencyIcon color="#71717a" />,
      iconActive: <CurrencyIcon color="#3f3f46" />,
    },
    {
      label: "Profile",
      href: "/dashboard/profile",
      icon: <UserCircleOutlinedIcon color="#71717a" />,
      iconActive: <UserCircleOutlinedIcon color="#3f3f46" />,
    },
  ];
